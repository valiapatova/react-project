(function (global, factory) {
    ...
    var seedData = {
    	...
    	comments: {
            ...
            "a4ee57b5-942d-4d3b-8ab6-4c6f4af60ad1": {
    			_ownerId: "35c62d76-8152-4626-8712-eeb96381bea8",
    			text: "K76 - Холетиаза",
    			postId: "4215d709-bf77-475f-8bb4-e6443d9cd3bf",
    			_createdOn: 1701794517485,
    			_id: "a4ee57b5-942d-4d3b-8ab6-4c6f4af60ad1"
    		},

            "0cb0e506-7a66-44e0-b3b7-0c05f9612514": {
    			_ownerId: "35c62d76-8152-4626-8712-eeb96381bea8",
    			text: "A10 - Алергия към полени",
    			postId: "20fa933e-88bd-4097-a714-8431153a9f77",
    			_createdOn: 1701794523731,
    			_id: "0cb0e506-7a66-44e0-b3b7-0c05f9612514"
    		},

            "1aa534da-789e-4d6b-9859-e4913254a081": {
    			_ownerId: "35c62d76-8152-4626-8712-eeb96381bea8",
    			text: "A12 - Алергия към текстилни бои",
    			postId: "20fa933e-88bd-4097-a714-8431153a9f77",
    			_createdOn: 1701813578793,
    			_id: "1aa534da-789e-4d6b-9859-e4913254a081"
    		},

            "35c62d76-8152-4626-8712-eeb96381bea8": {
    			_ownerId: "35c62d76-8152-4626-8712-eeb96381bea8",
    			text: "P06 - Предсърдно мъждене",
    			postId: "e13fb238-ee12-4b50-90be-833752cf1e55",
    			_createdOn: 1701815760391,
		...
		services: {
			...
			"07f260f4-466c-4607-9a33-f7273b24f1b4": {
				...
				maxLevel: "115",
                imageUrl: "https://res.cloudinary.com/doifgnlmu/image/upload/v1699975263/clients-well_v4vba3.jpg",
                summary: "CTM Рагон 14 обслужва над 100 фирми от цялата страна. Наши клиенти са Столичен инспекторат по образование, 57 Испанска гимназия Сезар Вайехо, 96 СОУ Лев Толстой, 40 СОУ Луи Пастьор, 19 СОУ Елин Пелин, Окръжен, Районен и Административен съд в Перник, Районен съд Лом, Сандански, Петрич, Сливница, РС Инженеринг, ЕОС АД, Булмес трейдинг АД, Ию Съндей АД, Рестохнолоджи АД, АСМ – БГ инвестиции и редица други фирми. ",
				summary2: "Извършени прегледи: Пълна гама ехографии, очен лекар, очна компютърна диагностика, кардиолог – ЕКГ, вътрешни болести, невролог.",
    			_createdOn: 1701271332335
    		},
			
			"bdabf5e9-23be-40a1-9f14-9117b6702a9d": {
    			_ownerId: "35c62d76-8152-4626-8712-eeb96381bea8",
    			title: "Изготвяне пакет от документи",
				category: "Документи",
				maxLevel: "114",
                imageUrl: "https://res.cloudinary.com/doifgnlmu/image/upload/v1699963834/medical-simbol1_brf7rx.png",
                summary: "Разработване на вътрешни правила за осигуряване на здравословни и безопасни условия на труд /чл. 277, ал. 1 и ал. 2 от КТ/, включващи - начален инструктаж на ГУТ и КУТ с издаване на удостоверения.",
    			summary2: "Помощ и съдействие при изготвяне на документи и тяхното прилагане: Инструкции за безопасна работа с работното оборудване; Раздел по безопасност на труда в характеристиките на работа. Разработване на програма и оценка на риска /ЗЗБУТ, чл. 16, ал. 1; Изготвяне на списък на Лични предпазни средства и Работно облекло /ЗЗБУТ и Наредба за безплатно и униформено работно облекло от 28.01.2011 г./",
				_createdOn: 1701271396423
    		},
			"7b3143e1-d6df-4e67-bd7e-5f8b03f2fd3f": {
				...
				maxLevel: "113",
                imageUrl: "https://res.cloudinary.com/doifgnlmu/image/upload/v1699963836/medicalSimvol3_toxfgb.jpg",
                summary: "Разработване на програма и оценка на риска /ЗЗБУТ, чл. 16, ал. 1; Наредба № 5 от 21.05.1999 год.; Наредба № 7 от 08.10.1999 год./",
				summary2: "Оценката на риска обхваща: Оценка на риска на работна среда. Помещения и работни места, използвани суровини и материали. Оценка на риска на работно място. Работни процеси.Работно оборудване. Определяне на изложените на риск лица. Риска за здравето при работа с високо нервно-психическо натоварване и неблагоприятни психо-социални фактори, наложен ритъм и монотонност, принудителна работна поза, ръчни товарно-разтоварни дейности. Изготвяне на Физиологичен режим на труд и почивка /ЗЗБУТ и Наредба № 15 от 31.05.1999 г. Изготвяне на списък на Лични предпазни средства и Работно облекло /ЗЗБУТ и Наредба за безплатно и униформено работно облекло от 28.01.2011г.",
    			_createdOn: 1701271471202
    	    }
        },
