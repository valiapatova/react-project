    ...
    var seedData = {
		...
		services: {
			...
			"07f260f4-466c-4607-9a33-f7273b24f1b4": {
				...
				summary2: "Преглед се извършват на място: Пълна гама ехографии, очен лекар, очна компютърна диагностика, кардиолог – ЕКГ, вътрешни болести, невролог.",
    			_createdOn: 1701271332335
    		},
			...
			"bdabf5e9-23be-40a1-9f14-9117b6702a9d": {
				...
				maxLevel: "114",
                imageUrl: "https://res.cloudinary.com/doifgnlmu/image/upload/v1699963834/medical-simbol1_brf7rx.png",
                summary: "Разработване на вътрешни правила за осигуряване на здравословни и безопасни условия на труд /чл. 277, ал. 1 и ал. 2 от КТ/, включващи - начален инструктаж на ГУТ и КУТ с издаване на удостоверения. Помощ и съдействие за тяхното изграждане и функциониране. Инструкции за безопасна работа с работното оборудване. Раздел по безопасност на труда в характеристиките на работа.",
    			summary2: "Изготвяне пакет от документи и съдействие за тяхното прилагане; Инструкции за безопасна работа с работното оборудване; Раздел по безопасност на труда в характеристиките на работа. Разработване на програма и оценка на риска /ЗЗБУТ, чл. 16, ал. 1; Изготвяне на списък на Лични предпазни средства и Работно облекло /ЗЗБУТ и Наредба за безплатно и униформено работно облекло от 28.01.2011 г./",
				_createdOn: 1701271396423
    		},
